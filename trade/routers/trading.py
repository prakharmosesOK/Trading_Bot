...
def trading():
     print("At least coming here inside the function!")
     ...
     def strategy1(API_KEY, API_SECRET, BASE_URL):
          ...
          for i in dataNames:
               ...
               print("Coming into the loop of trade!")
               client = Client("http://59c6f89b1e863e6d95.gradio.live/")
               orders = client.predict(
                    stock_ticker = i,
                    api_key = "PKGIEGJDZUKNBN11G9EA",
                    api_secret = "QXP9sxxnvRjrZCLWdFeoN0rEbhZuhKCvPbF95lrI",
     ...
     # Start the scheduler
     print("Coming just before while loop!")
     while True:
          try:
